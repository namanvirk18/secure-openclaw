...
<p style="max-width: 900px; margin: 20px auto; text-align: left;">A self-hosted AI assistant that runs 24/7 on WhatsApp, Telegram, or iMessage and connects to 500+ apps without the agent ever touching your credentials.</p>

<img src="https://github.com/namanvirk18/secure-openclaw/blob/master/assets/secure-openclaw.gif?raw=true" alt="Secure OpenClaw Demo" width="700">
